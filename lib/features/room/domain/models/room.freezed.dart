...
abstract class $RoomCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String code, String hostPlayerId, RoomStatus status});
}
...
class _$RoomImpl implements _Room {
  ...
  @override
  String toString() {
    return 'Room(id: $id, code: $code, hostPlayerId: $hostPlayerId, status: $status)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, code, hostPlayerId, status);
...
abstract class _Room implements Room {
  const factory _Room(
      ...
      required final RoomStatus status}) = _$RoomImpl;
